...
var detectNetwork = function(cardNumber) {
  if (cardNumber.length === 14 && (cardNumber.substring(0,2) === '38' || cardNumber.substring(0,2) === '39')) {
    ...
    return 'Switch';
  	...
  	return 'Visa';
  } else if (cardNumber.length === 16 && (Number(cardNumber.substring(0,2)) >= 51 && Number(cardNumber.substring(0,2)) <= 55)) {
  	return 'MasterCard';
  } else if ((cardNumber.length === 16 || cardNumber.length === 19) && (cardNumber.substring(0,4) === '6011' || cardNumber.substring(0,2) === '65' || (Number(cardNumber.substring(0,3)) >= 644 && Number(cardNumber.substring(0,3)) <= 649))) {
    return 'Discover';
    ...
    return 'Maestro';
  } else if ((cardNumber.length >= 16 && cardNumber.length <= 19) && ((Number(cardNumber.substring(0,6)) >= 622126 && Number(cardNumber.substring(0,6)) <= 622925) || (Number(cardNumber.substring(0,3)) >= 624 && Number(cardNumber.substring(0,3)) <= 626)  || (Number(cardNumber.substring(0,4)) >= 6282 && Number(cardNumber.substring(0,4)) <= 622925))) {
