...
// it('has a prefix of 51 and has a length of 16', function() {
...
describe('Switch', function () {
  ...
  for (var i = 0; i < array.length; i++) {
    var element = array[i];
    (function(element) {
      var numOfRepeatChars = 16 - element.length;
      var exampleNum = '1';
      it('has a prefix of ' + element + ' and a length of ' + (element.length + numOfRepeatChars), function() {
        detectNetwork(element + exampleNum.repeat(numOfRepeatChars)).should.equal("Switch");
      })
    }) (element);
  }
  for (var j = 0; j < array.length; j++) {
    var element = array[j];
    (function(element) {
      var numOfRepeatChars = 18 - element.length;
      var exampleNum = '1';
      it('has a prefix of ' + element + ' and a length of ' + (element.length + numOfRepeatChars), function() {
        detectNetwork(element + exampleNum.repeat(numOfRepeatChars)).should.equal("Switch");
      })
  ...
  for (var k = 0; k < array.length; k++) {
    var element = array[k];
    (function(element) {
      var numOfRepeatChars = 19 - element.length;
      var exampleNum = '1';
      it('has a prefix of ' + element + ' and a length of ' + (element.length + numOfRepeatChars), function() {
        detectNetwork(element + exampleNum.repeat(numOfRepeatChars)).should.equal("Switch");
      })
